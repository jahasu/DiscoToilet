...
func turnOnLights() {
	...
	//-------------------------------------------
	dmx.SetChannel(30, 255) //dimmer
	dmx.SetChannel(31, 0)   //strobe
	dmx.SetChannel(32, 255) //red
	dmx.SetChannel(33, 0)   //green
	dmx.SetChannel(34, 255) //blue
	...
	dmx.SetChannel(67, 50)  //strobe
	dmx.SetChannel(68, 255) //red
	dmx.SetChannel(69, 0)   //green
	dmx.SetChannel(70, 255) //blue
	dmx.SetChannel(71, 0)   //yellow
	dmx.SetChannel(72, 255) //laser r
	dmx.SetChannel(73, 0)   //laser g
	dmx.SetChannel(74, 255) //pan rotate
	...
	for {
		...
		if pin.Read() == 0 {
			...
			if power == 0 {
				...
				relay1.Low()
				relay2.High()
				cmdMusic := exec.Command("cvlc", "--random", "--play-and-exit", "/home/pi/Music/bathroom_jack.mp3")
